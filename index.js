...
const TOKEN = 'MTUwOTc4Mzc1NDQzOTM5MzQyMA.GzfkE_.rYRFeb1vJJH4_J31Ieu0NMp2b0pTo6fl0K-czw';
const ADMIN_IDS = ['1422889657816842312'];
...
function createMainEmbed() {
    const embed = new EmbedBuilder()
        .setTitle('✔️ : ระบบออนช่องเสียง Discord')
        .setColor(0x66FF66)
        .setDescription(`
**✔️ : ตั้งค่าข้อมูลการออนช่องเสียง
✔️ : จัดการการออนช่องเสียง
✔️ : กด เริ่มออน เพื่อเริ่มออนช่องเสียง**
`)
...
function updateBotStatus() {
    ...
    const statusOptions = [
        {
            name: `🌿 : ผู้ใช้งานอยู่ ${activeUsers} `,
            type: 4,
            state: `✅ : บอทอ่านคำสั่งอยู่ ${serverCount} servers`
        },
        {
           name: `🌿 : ผู้ใช้งานอยู่ ${activeUsers} `,
            type: 4,
